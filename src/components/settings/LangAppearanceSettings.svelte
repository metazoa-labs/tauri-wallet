...
<main class="uk-margin">
  ...
  <!-- <h5 class="uk-text-light uk-text-uppercase uk-text-muted uk-text-thin">{$_("settings.langapp_settings.theme")}</h5>
  <p>{$_("settings.langapp_settings.theme_description")}</p> -->
